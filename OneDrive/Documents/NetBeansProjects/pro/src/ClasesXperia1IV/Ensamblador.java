    ...
    public void ensamblarTelefono(int cantidad) {
        try {
            ...
            if (!this.tienePantalla) {
                ...
                int numPantallas = Test1.almacen.getPantalla();
                if ((numPantallas - 1) >= 0) {
                    Test1.almacen.setPantalla(numPantallas - 1);
            ...
            if (!this.tienePin) {
                ...
                int numPin = Test1.almacen.getPinCarga();
                if ((numPin - 1) >= 0) {
                    Test1.almacen.setPinCarga(numPin - 1);
                    this.tienePin = true;
                }
